...
<sql:query var="result" dataSource="jdbc/miniprojet" >select * FROM fournisseur</sql:query>
		...
		<tbody>
		 <c:forEach var="Ligne" items="${result.rows}">
            <tr> 
                ...
                <td><a href="${pageContext.request.contextPath}/supprimerfournisseur?id=${Ligne.id}">supprimer</a></td>
            </tr>
        </c:forEach>
